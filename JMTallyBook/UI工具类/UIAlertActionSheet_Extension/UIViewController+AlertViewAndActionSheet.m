...
//            NSMutableAttributedString *hogan = [[NSMutableAttributedString alloc] initWithString:obj];
//            [hogan addAttribute:NSFontAttributeName value:BOLDSYSTEMFONT(17) range:NSMakeRange(0, [[hogan string] length])];
//            [hogan addAttribute:NSForegroundColorAttributeName value:HexColor(@"1971ff") range:NSMakeRange(0, [[hogan string] length])];
//            [action setValue:hogan forKey:@"attributedMessage"];
